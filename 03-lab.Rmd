...
```{r rmark4, echo=FALSE, out.width='40%', fig.align='center', fig.cap='Ejemplo de base de datos en excel'}
knitr::include_graphics("imagenes/fig4_basedatos.png")
```
...
```{r rmark5, echo=FALSE, out.width='80%', fig.align='center', fig.cap='Importación de datos desde Rstudio'}
knitr::include_graphics("imagenes/fig5_imp_datos.png")
```
...
```{r rmark6, echo=FALSE, out.width='80%', fig.align='center', fig.cap='Paso final para Importación de datos'}
knitr::include_graphics("imagenes/fig5_import.png")
```
...
```{r rmark7, echo=FALSE, out.width='80%', fig.align='center', fig.cap='Instalación de paquete dplyr'}
knitr::include_graphics("imagenes/fig7_dplyr.png")
```
...
```{r rmark8, echo=FALSE, out.width='80%', fig.align='center', fig.cap='Instalación de paquete dplyr (2do paso)'}
knitr::include_graphics("imagenes/fig8_dplyr.png")
```
