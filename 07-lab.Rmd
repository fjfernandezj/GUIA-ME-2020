...
* `X-squared` = `r chtest$statistic` Es el estadístico de la prueba 

* `df` = 1 Grados de libertad

* `p-value` = `r chtest$p.value` p-valor
...
Nuestro análisis nos permite concluir que la proporción de trabajadores enfermos fue significativamente mayor en trabajadores que manipularon herbicidas durante la jornada laboral en comparación a aquellos trabajadores que no manipularon herbicidas (X^2^ ~(1)~ = `r chtest$statistic`, p< 0.05). 
